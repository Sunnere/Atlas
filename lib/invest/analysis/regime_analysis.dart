...
class AtlasRegimeAnalyzer {
  ...
  List<RegimeHorizonResult> analyze(
    List<MarketObservation> observations, {
    List<int> horizons = const [3, 5, 20],
  }) {
    final results = <RegimeHorizonResult>[];
